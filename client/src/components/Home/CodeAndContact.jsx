    ...
    return (
        <main className='codeOfConduct-container'>
            <section>
                ...
                <h2 className="heading-para-code">Fostering an Open and Welcoming Community</h2>
                <p className='paragraph-codeConduct'>CNCF's Code of Conduct and Linux Foundation's Events Code of Conduct applies to KCD Chennai and its Organizers, Volunteers, Chapter members, Speakers, Staff and Attendees. Report violations to the organizers by contacting organizers-chennai@kubernetescomrnunitydays.org or the CNCF staff at conduct@cncf.io.</p>
            </section>
