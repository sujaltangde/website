...
export const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className='navBg shadow-sm fixed w-full flex  justify-around md:justify-evenly rounded-b-xl py-2  md:py-4 items-center'>
                ...
                <div className='md:ml-0 ml-6'>
                  <button className='text-white text-xs md:text-sm border-2 border-blue-500 rounded-3xl btn-bg py-0.5 font-semibold px-4 md:px-5'>Join Us</button>
                </div>
