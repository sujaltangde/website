...
const Team = () => {
    return (
        <div className="min-h-screen pt-20 text-white">
            ...
            <div className="flex flex-wrap gap-10 mb-32  w-full mt-16 md:px-24 px-4 items-center justify-center">
                {TeamArray.map((e, i) => (
                    <div key={i} className="w-60 mx-8 ">
                        ...
                        <div className="flex flex-col items-center mt-2 justify-center">
                            ...
                            <p className="text-xs text-gray-400 font-mona-sans-medium">
                                {e.position}
                            </p>
                        </div>
                    </div>
